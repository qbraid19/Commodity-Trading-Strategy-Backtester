        ...
        with st.spinner("Loading data and computing signals..."):
            try:
                ...
                with st.sidebar:
                    ...
                    st.markdown(f"""
                    <div style="font-family: 'Monaco', 'Courier New', monospace; font-size: 1rem; white-space: pre; line-height: 1.4; margin: -1rem 0;">
...
def create_strategy(strategy_type, params):
    ...
    if strategy_type == 'ma_crossover':
        ...
        return CalendarSpreadStrategy(**params)
    elif strategy_type == 'log_momentum':
...
def get_comparison_commodities(selected_instrument):
    ...
    physical_commodities = {
        'WTI Crude Oil': ['BRENT', 'GASOLINE', 'HEATING_OIL','WTI Crude Oil'],
        'Brent Crude Oil': ['WTI', 'GASOLINE', 'HEATING_OIL','Brent Crude Oil'], 
